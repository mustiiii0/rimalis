        ...
        <div class="doc-inner">
          ...
          <div class="doc-bottom" style="border-top: 1px solid var(--rule); margin-top: 10px;">
            ...
            <div class="footer-qr-wrap">
              <img src="${qrDataUrl}" width="22" height="22" alt="QR">
            </div>
            <div class="footer-page-num">صفحة 1 من 2 · ${display(d.contractNumber)}</div>
        </div>
      </div>
      ...
      <div class="doc-page">
        ...
        <div class="doc-inner">
          ...
          ` : ""}
            ...
            <div class="footer-page-num">صفحة 2 من 2 · ${display(d.contractNumber)}</div>
        </div>
      </div>
    `;
